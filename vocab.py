...
class VocabEntry(object):
    ...
    def words2charindices(self, sents):
        ...
        def word2charindices(word):
            char_ind_list = [self.char2id['{']]
            char_ind_list.extend([self.char2id[c] for c in list(word)])
    ...
    def to_input_tensor_char(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        return sents_padded_tensor_reshaped.contiguous()
        ### END YOUR CODE
